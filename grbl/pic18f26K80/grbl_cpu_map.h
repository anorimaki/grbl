...
#ifndef PIC18F26K80_cpu_map_h
#define PIC18F26K80_cpu_map_h
  ...
  #define STEP_DDR        TRISA
  #define STEP_PORT       LATA
  ...
  #define DIRECTION_DDR     TRISA
  #define DIRECTION_PORT    LATA
  ...
  #define STEPPERS_DISABLE_DDR    TRISA
  #define STEPPERS_DISABLE_PORT   LATA
  ...
  #define SPINDLE_ENABLE_DDR    TRISC
  #define SPINDLE_ENABLE_PORT   LATC
  // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
    ...
    #else
      #define SPINDLE_ENABLE_BIT    1  // Uno Digital Pin 11
    #endif
  #else
    #define SPINDLE_ENABLE_BIT    1  // Uno Digital Pin 12
  #endif
  #ifndef USE_SPINDLE_DIR_AS_ENABLE_PIN
    #define SPINDLE_DIRECTION_DDR   TRISC
    #define SPINDLE_DIRECTION_PORT  LATC
  ...
  #define CONTROL_DDR       TRISB
  #define CONTROL_PIN       PORTB
  #define CONTROL_PORT      WPUB
  ...
  #define PROBE_DDR       TRISB
  #define PROBE_PIN       PORTB
  #define PROBE_PORT      WPUB
  ...
  #define SPINDLE_PWM_DDR	  TRISC
  #define SPINDLE_PWM_PORT    LATC
  #define SPINDLE_PWM_BIT	  2    // Uno Digital Pin 11
